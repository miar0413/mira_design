...
const About: React.FC = () => {
  ...
  return (
    <div>
      <Header />
      <div className="max-w-7xl mb-[100px] py-6 px-4 sm:px-6 lg:px-8 mx-auto flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-8">
        {/* 图片部分 */}
        ...
        <div className="flex-1">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4">
              ...
              <div className="indent-8">
                {locales[locale].aboutMe.hobbyText1}
              </div>
              <div className="indent-8">
                {locales[locale].aboutMe.hobbyText2}
              </div>
            </div>
          </div>
        </div>
